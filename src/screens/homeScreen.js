...
export const HomeScreen = () => {
  return (
    <div>
      <div className="bg-landing h-96 min-h-full flex items-end relative">
        ...
        <div className="flex max-w-6xl mx-auto h-auto  p-4 relative z-20 flex-col justify-end ">
          <div className="py-8">
            <p className="text-white text-4xl md:text-6xl mb-2 font-serif text-center">
              Join The Club
            </p>
      ...
      <div className="bg-gray-300 flex flex-col justify-center items-center min-h-full h-96 py-8">
        <div className="container flex flex-col items-center w-full  bg-gray-200 p-6 rounded-md">
          ...
          <button className="bg-blue-500 mt-8 hover:bg-blue-700 text-white font-md py-2 px-4 rounded">
            Start Now
          </button>
        </div>
      </div>
      ...
      {/* box2 */}
      <div
        className={`bg-image1 bg-cover  min-h-full py-11 flex flex-col justify-center items-center `}
      >
      ...
      {/* box3 */}
      <div
        className={`bg-meetings bg-fixed bg-opacity-5  bg-cover flex flex-col items-center h-96 min-h-full py-11 relative`}
      >
        ...
        <div className="w-full h-full bg-opacity-5 p-6 py-11 absolute z-20 top-8 left-0">
          <p className="text-gray-100 font-serif font-bold text-4xl md:text-6xl max-w-2xl mx-auto text-center mb-4 ">
